...
//  Handle termination signal update
...
// Fetch machine keys data for display
...
<body>
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-header">
                ...
                <img src="<?= htmlspecialchars($currentUserInfo['profile_pic'] ?: '../assets/img/phonex.jpg') ?>" alt="User Avatar" class="img-fluid rounded-circle mb-2">
    ...
    <!--  Scripts for Bootstrap and Sidebar toggle -->
